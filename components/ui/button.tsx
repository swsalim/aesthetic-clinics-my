...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md transition-colors duration-200 ease-in-out',
  {
    variants: {
      variant: {
        primary:
          'border border-solid border-transparent bg-blue-500 text-white hover:bg-blue-600 hover:text-white focus:border-blue-600 focus:outline-none active:bg-blue-600',
        secondary:
        ...
        ghost:
          'bg-transparent text-gray-700 hover:border-transparent hover:bg-gray-100 hover:text-gray-700 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 dark:text-blue-600 dark:hover:border-transparent dark:hover:bg-blue-200/40 dark:hover:text-blue-800',
        danger:
