  ...
  return (
    <Component
      className={cn(
        ...
        // headings
        'prose-headings:font-display prose-headings:relative prose-headings:scroll-mt-[6rem] prose-headings:capitalize prose-h1:mb-4 prose-h1:font-black prose-h1:leading-snug prose-h2:text-xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-medium md:prose-h2:text-2xl md:prose-h3:text-xl',
        // lead
